...
public class CmmUtils {
    ...
    public static Map getRequestApi(Map<String,Object> paramMap) throws Exception{
        ...
        resultMap.put("resultData", convertStringItemsToXml(sb.toString()));
     ...
     */
    public static List<Map<String,Object> > convertStringItemsToXml(String strXml) throws Exception{
